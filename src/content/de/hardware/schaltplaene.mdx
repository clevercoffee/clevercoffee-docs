...
<Caution lang={props.params.lang} />
...
> [!IMPORTANT]
>
> Dieser Umbau darf nur am Brüh-Schalter vorgenommen werden, wenn ein Schalter ohne Lampe genommen oder die Lampe ausgebaut oder eine neue Verkabelung bzw. der LED-Umbau gewählt wird, dass mit eingebauter Lampe **KEINE** 3,3 Volt und 230 Volt am Schalter anliegen! Sonst liegt **KEINE** galvanische Trennung zwischen 3,3 Volt und 230 Volt mehr vor! Das kann unter ungünstigen Umständen gefährlich für dich oder den Microcontroller sein!
...
<KiCAD
  src="https://raw.githubusercontent.com/rancilio-pid/clevercoffee-hardware/refs/heads/master/wiring_diagrams/ESP32_minimal_full_featured.kicad_sch"
  width="800px"
  height="600px"
  controls="none"
/>